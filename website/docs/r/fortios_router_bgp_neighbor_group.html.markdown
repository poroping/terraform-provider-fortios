...
## fortios_router_bgp_neighbor_group
BGP neighbor group table.
...
router_neighbor_group can be imported using any of these accepted formats:
```
$ export "FORTIOS_IMPORT_TABLE"="true"
$ terraform import fortios_router_neighbor_group.labelname {{name}}
