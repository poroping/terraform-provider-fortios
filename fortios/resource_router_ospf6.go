...
func resourceRouterOspf6() *schema.Resource {
	return &schema.Resource{
		Create: resourceRouterOspf6Create,
		...
		Schema: map[string]*schema.Schema{
			...
			"abr_type": {
				Type:         schema.TypeString,
				ValidateFunc: fortiValidateEnum([]string{"cisco", "ibm", "standard"}),
			...
			"area": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"authentication": {
							Type:         schema.TypeString,
							ValidateFunc: fortiValidateEnum([]string{"none", "ah", "esp"}),
						...
						"ipsec_auth_alg": {
							Type:         schema.TypeString,
							ValidateFunc: fortiValidateEnum([]string{"md5", "sha1", "sha256", "sha384", "sha512"}),
						...
						"ipsec_enc_alg": {
							Type:         schema.TypeString,
							ValidateFunc: fortiValidateEnum([]string{"null", "des", "3des", "aes128", "aes192", "aes256"}),
						...
						"virtual_link": {
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"authentication": {
										Type:         schema.TypeString,
										ValidateFunc: fortiValidateEnum([]string{"none", "ah", "esp", "area"}),
			...
			"ospf6_interface": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"network_type": {
							Type:         schema.TypeString,
							ValidateFunc: fortiValidateEnum([]string{"broadcast", "point-to-point", "non-broadcast", "point-to-multipoint", "point-to-multipoint-non-broadcast"}),
...
func resourceRouterOspf6Create(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectRouterOspf6(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error creating RouterOspf6 resource while getting object: %v", err)
	}

	o, err := c.UpdateRouterOspf6(obj, "RouterOspf6", vdomparam, urlparams, batchid)

	if err != nil {
		return fmt.Errorf("error creating RouterOspf6 resource: %v", err)
	}
...
func resourceRouterOspf6Delete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteRouterOspf6(mkey, vdomparam, batchid)
	if err != nil {
...
func getObjectRouterOspf6(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
