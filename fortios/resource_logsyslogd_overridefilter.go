...
func resourceLogSyslogdOverrideFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogdOverrideFilter(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogSyslogdOverrideFilter resource while getting object: %v", err)
	}

	o, err := c.UpdateLogSyslogdOverrideFilter(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogSyslogdOverrideFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogSyslogdOverrideFilter(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogSyslogdOverrideFilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogSyslogdOverrideFilter(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogSyslogdOverrideFilter(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
