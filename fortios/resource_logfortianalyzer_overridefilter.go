...
func resourceLogFortianalyzerOverrideFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzerOverrideFilter(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogFortianalyzerOverrideFilter resource while getting object: %v", err)
	}

	o, err := c.UpdateLogFortianalyzerOverrideFilter(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogFortianalyzerOverrideFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogFortianalyzerOverrideFilter(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogFortianalyzerOverrideFilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogFortianalyzerOverrideFilter(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogFortianalyzerOverrideFilter(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
