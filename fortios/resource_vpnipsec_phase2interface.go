...
func resourceVpnIpsecPhase2Interface() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"add_route": {
				Type:         schema.TypeString,
				ValidateFunc: fortiValidateEnum([]string{"phase1", "enable", "disable"}),
				Optional:     true,
				Computed:     true,
			},
			...
			"keylife_type": {
				Type:         schema.TypeString,
				ValidateFunc: fortiValidateEnum([]string{"seconds", "kbs", "both"}),
				Optional:     true,
				Computed:     true,
			},
			"single_source": {
			...
			"src_addr_type": {
				Type:         schema.TypeString,
				ValidateFunc: fortiValidateEnum([]string{"subnet", "range", "ip", "name", "subnet6", "range6", "ip6", "name6"}),
				Optional:     true,
				Computed:     true,
			},
			"src_start_ip": {
...
func resourceVpnIpsecPhase2InterfaceCreate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.CreateVpnIpsecPhase2Interface(obj, vdomparam, urlparams, batchid)
...
func resourceVpnIpsecPhase2InterfaceUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateVpnIpsecPhase2Interface(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceVpnIpsecPhase2InterfaceDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteVpnIpsecPhase2Interface(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceVpnIpsecPhase2InterfaceRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadVpnIpsecPhase2Interface(mkey, vdomparam, urlparams, batchid)
	if err != nil {
