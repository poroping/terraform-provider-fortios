...
func resourceLogFortianalyzer2OverrideSettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer2OverrideSetting(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogFortianalyzer2OverrideSetting resource while getting object: %v", err)
	}

	o, err := c.UpdateLogFortianalyzer2OverrideSetting(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogFortianalyzer2OverrideSettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogFortianalyzer2OverrideSetting(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogFortianalyzer2OverrideSettingRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogFortianalyzer2OverrideSetting(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogFortianalyzer2OverrideSetting(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
