...
func resourceSystemReplacemsgDeviceDetectionPortalUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateSystemReplacemsgDeviceDetectionPortal(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceSystemReplacemsgDeviceDetectionPortalDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteSystemReplacemsgDeviceDetectionPortal(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceSystemReplacemsgDeviceDetectionPortalRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadSystemReplacemsgDeviceDetectionPortal(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectSystemReplacemsgDeviceDetectionPortal(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
