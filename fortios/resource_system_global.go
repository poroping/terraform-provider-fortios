	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"user_device_store_max_devices": {
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(10541, 30118),
				Optional:     true,
				Computed:     true,
			},
			...
			"faz_disk_buffer_size": {
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(0, 161061273),
				Optional:     true,
				Computed:     true,
			},
			"irq_time_accounting": {
...
func resourceSystemGlobalUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateSystemGlobal(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceSystemGlobalDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteSystemGlobal(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceSystemGlobalRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadSystemGlobal(mkey, vdomparam, urlparams, batchid)
	if err != nil {
