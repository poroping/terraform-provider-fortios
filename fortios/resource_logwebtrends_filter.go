...
func resourceLogWebtrendsFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogWebtrendsFilter(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogWebtrendsFilter resource while getting object: %v", err)
	}

	o, err := c.UpdateLogWebtrendsFilter(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogWebtrendsFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogWebtrendsFilter(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogWebtrendsFilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogWebtrendsFilter(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogWebtrendsFilter(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
