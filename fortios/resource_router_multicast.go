...
func resourceRouterMulticastUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateRouterMulticast(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceRouterMulticastDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateRouterMulticast(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceRouterMulticastRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadRouterMulticast(mkey, vdomparam, urlparams, batchid)
	if err != nil {
