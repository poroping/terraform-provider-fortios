...
func resourceSystemReplacemsgFortiguardWfUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateSystemReplacemsgFortiguardWf(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceSystemReplacemsgFortiguardWfDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteSystemReplacemsgFortiguardWf(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceSystemReplacemsgFortiguardWfRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadSystemReplacemsgFortiguardWf(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectSystemReplacemsgFortiguardWf(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
