...
func dataSourceFirewallCentralSnatMapList() *schema.Resource {
...
func dataSourceFirewallCentralSnatMapListRead(d *schema.ResourceData, m interface{}) error {
	...
	d.SetId("DataSourceFirewallCentralSnatMapList" + filter)
