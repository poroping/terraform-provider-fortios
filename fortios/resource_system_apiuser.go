...
func flattenSystemApiUserName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemApiUserComments(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemApiUserVdom(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	if v == nil {
		return nil
	}
...
func flattenSystemApiUserVdomName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemApiUserSchedule(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemApiUserCorsAllowOrigin(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemApiUserPeerAuth(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemApiUserPeerGroup(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemApiUserTrusthostIpv4Trusthost(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
...
func flattenSystemApiUserTrusthostIpv6Trusthost(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func expandSystemApiUserName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserComments(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserApiKey(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserAccprofile(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemApiUserVdomName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserSchedule(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserCorsAllowOrigin(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserPeerAuth(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserPeerGroup(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemApiUserTrusthostId(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserTrusthostType(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserTrusthostIpv4Trusthost(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemApiUserTrusthostIpv6Trusthost(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func getObjectSystemApiUser(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
