...
func resourceSystemReplacemsgUtmUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateSystemReplacemsgUtm(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceSystemReplacemsgUtmDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteSystemReplacemsgUtm(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceSystemReplacemsgUtmRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadSystemReplacemsgUtm(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectSystemReplacemsgUtm(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
