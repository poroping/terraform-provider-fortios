...
func resourceLogFortianalyzerFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzerFilter(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogFortianalyzerFilter resource while getting object: %v", err)
	}

	o, err := c.UpdateLogFortianalyzerFilter(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogFortianalyzerFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogFortianalyzerFilter(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogFortianalyzerFilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogFortianalyzerFilter(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogFortianalyzerFilter(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
