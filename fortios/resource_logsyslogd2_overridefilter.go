...
func resourceLogSyslogd2OverrideFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd2OverrideFilter(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogSyslogd2OverrideFilter resource while getting object: %v", err)
	}

	o, err := c.UpdateLogSyslogd2OverrideFilter(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogSyslogd2OverrideFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogSyslogd2OverrideFilter(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogSyslogd2OverrideFilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogSyslogd2OverrideFilter(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogSyslogd2OverrideFilter(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
