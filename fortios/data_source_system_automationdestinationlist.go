...
func dataSourceSystemAutomationDestinationList() *schema.Resource {
...
func dataSourceSystemAutomationDestinationListRead(d *schema.ResourceData, m interface{}) error {
	...
	d.SetId("DataSourceSystemAutomationDestinationList" + filter)
