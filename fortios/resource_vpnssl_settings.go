...
func resourceVpnSslSettingsUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateVpnSslSettings(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceVpnSslSettingsDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateVpnSslSettings(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceVpnSslSettingsRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadVpnSslSettings(mkey, vdomparam, urlparams, batchid)
	if err != nil {
