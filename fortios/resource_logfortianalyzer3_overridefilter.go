...
func resourceLogFortianalyzer3OverrideFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer3OverrideFilter(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogFortianalyzer3OverrideFilter resource while getting object: %v", err)
	}

	o, err := c.UpdateLogFortianalyzer3OverrideFilter(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogFortianalyzer3OverrideFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogFortianalyzer3OverrideFilter(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogFortianalyzer3OverrideFilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogFortianalyzer3OverrideFilter(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogFortianalyzer3OverrideFilter(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
