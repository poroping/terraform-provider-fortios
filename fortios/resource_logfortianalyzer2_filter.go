...
func resourceLogFortianalyzer2FilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer2Filter(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogFortianalyzer2Filter resource while getting object: %v", err)
	}

	o, err := c.UpdateLogFortianalyzer2Filter(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogFortianalyzer2FilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogFortianalyzer2Filter(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogFortianalyzer2FilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogFortianalyzer2Filter(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogFortianalyzer2Filter(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
