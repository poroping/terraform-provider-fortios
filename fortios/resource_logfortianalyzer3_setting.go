...
func resourceLogFortianalyzer3SettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer3Setting(d, c.Fv)
	if err != nil {
		return fmt.Errorf("error updating LogFortianalyzer3Setting resource while getting object: %v", err)
	}

	o, err := c.UpdateLogFortianalyzer3Setting(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceLogFortianalyzer3SettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteLogFortianalyzer3Setting(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceLogFortianalyzer3SettingRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogFortianalyzer3Setting(mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func getObjectLogFortianalyzer3Setting(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
