...
func dataSourceFirewallInternetServiceCustomList() *schema.Resource {
...
func dataSourceFirewallInternetServiceCustomListRead(d *schema.ResourceData, m interface{}) error {
	...
	d.SetId("DataSourceFirewallInternetServiceCustomList" + filter)
