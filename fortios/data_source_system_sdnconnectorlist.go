...
func dataSourceSystemSdnConnectorList() *schema.Resource {
...
func dataSourceSystemSdnConnectorListRead(d *schema.ResourceData, m interface{}) error {
	...
	d.SetId("DataSourceSystemSdnConnectorList" + filter)
