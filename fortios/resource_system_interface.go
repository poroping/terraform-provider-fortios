...
func resourceSystemInterfaceCreate(d *schema.ResourceData, m interface{}) error {
	...
	if v == "physical" || ag == "auto" {
		o, err = c.UpdateSystemInterface(obj, (*obj)["name"].(string), vdomparam, urlparams, batchid)
	} else {
		o, err = c.CreateSystemInterface(obj, vdomparam, urlparams, batchid)
	}
...
func resourceSystemInterfaceUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateSystemInterface(obj, mkey, vdomparam, urlparams, batchid)
	if err != nil {
...
func resourceSystemInterfaceDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteSystemInterface(mkey, vdomparam, batchid)
	if err != nil {
...
func resourceSystemInterfaceRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadSystemInterface(mkey, vdomparam, urlparams, batchid)
	if err != nil {
